...
<body>
    <div id="synch_set" class="set-wrap">
    	<div class="wrap-inner">
            ...
            <form action="<?php echo XWB_plugin::URL("xwbSiteInterface.doPluginCfg4Sync");?>" id="siteRegFrom"  method="post" target="xwbHideFrame">
            	<ul>
                	<li>
                    ...
                    <li>
                    	<label for="part4">
                        	<input class="chk" id="part4" name="pluginCfg[is_rebutton_display]" type="checkbox" value="1" <?php echo XWB_plugin::pCfg('is_rebutton_display') ? 'checked="checked"' : '' ?> />开启转发到微博功能<span>（开启后再主题贴、日志和相册页面会出现转发按钮）</span>
                        </label>
                    </li>
                    <li>
                    	<label for="part5">
