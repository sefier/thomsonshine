...
<body>
    <div id="unbound" class="set-wrap">
        ...
        <div class="main">
        	<div class="con-l">
                <div class="binding">
                	<a class="binding-btn binding-w" href="javascript:void(0)" onclick="window.top.location='<?php echo XWB_plugin::URL('xwbAuth.login');?>'"><span>绑定新浪微博</span></a>
                    <a href="http://t.sina.com.cn/reg.php" target="_blank">注册新浪微博</a>
                </div>
            </div> 
            <div class="con-r">
				<h4>绑定新浪微博账号后，您可以:</h4>
        ...
        <div class="active-s1">
            ...
            <div class="users">
                ...
                <div class="user-info">
                    ...
                    <a class="addfollow-btn" href="<?php echo "http://t.sina.com.cn/{$value[sina_uid]}"?>" target="_blank"></a>
