...
<body>
    <div id="app_set" class="set-wrap">
        <form action="<?php echo XWB_plugin::URL("xwbSiteInterface.doPluginCfg");?>" onsubmit="return beforeSubmit();" id="siteRegFrom"  method="post" target="xwbHideFrame">
    	<div class="wrap-inner">
			...
			<div class="set-s1">
                ...
                <p><label for="two">
                    <input class="chk" id="two" name="pluginCfg[bind_btn_usernav]" type="checkbox" value="1" <?php echo XWB_plugin::pCfg('bind_btn_usernav') ? 'checked="checked"' : ''; ?> />2、在header显示绑定微薄的提示按钮
                </label></p>
                <p><label for="three">
        ...
        <div class="wrap-inner">
            ...
            <div class="set-s2">
            	...
            	<div class="conmon">
                	<label for="p1">
                        <input class="chk" id="p1" name="pluginCfg[is_wbx_display]" type="checkbox" value="1" <?php echo XWB_plugin::pCfg('is_wbx_display') ? 'checked="checked"' : '' ?> />开启微博秀功能
                    </label>
                </div>
            	<div class="panel">
            		<div class="panel-l">
                    	<h4 class="wbx-set">微博秀设置</h4>
                        <div class="inner">
                            	<div class="con-wrap">
                            		<h4>设置尺寸：</h4>
                                	<span class="con-edge">高<input name="pluginCfg[wbx_height]" class="input-box size-w" type="text" value="<?php echo XWB_plugin::pCfg('wbx_height');?>" onblur="updatePreview()" />px</span>
                                	<p id="size_warn_tip">宽度:固定180px，高度:75-500px</p>
                            	</div>
                        		<div class="con-wrap">
                            		<h4>模块设置:</h4>
                                	<span class="con-edge">
                                    	<input id="chk_wbx_is_title" name="pluginCfg[wbx_is_title]" class="chk" type="checkbox" value="1" <?php echo XWB_plugin::pCfg('wbx_is_title') ? 'checked="checked"' : '' ?> onclick="oncheckboxchange()" />
                                    	<label for="chk_wbx_is_title">显示标题栏</label>
                                    </span>
                                	<span class="con-edge">
                                    	<input id="chk_wbx_is_blog" name="pluginCfg[wbx_is_blog]" class="chk" type="checkbox" value="1" <?php echo XWB_plugin::pCfg('wbx_is_blog') ? 'checked="checked"' : '' ?> onclick="oncheckboxchange()" />
                                    	<label for="chk_wbx_is_blog">展示微博</label>
                                    </span><br />
                                	<span class="con-edge">
                                    	<input id="chk_wbx_is_fans" name="pluginCfg[wbx_is_fans]" class="chk" type="checkbox" value="1" <?php echo XWB_plugin::pCfg('wbx_is_fans') ? 'checked="checked"' : '' ?> onclick="oncheckboxchange()" />
                                    	<label for="chk_wbx_is_fans">展示粉丝</label>
                                    </span>
                            	</div>
                            	<div class="con-wrap">
                            		<h4>外观方案:</h4>
                            		<input type="hidden" name="pluginCfg[wbx_style]" value="<?php echo XWB_plugin::pCfg('wbx_style');?>"/>
                                	<div class="color-slt" id="skin_set">
                                        <a href="javascript:void(0)" onclick="onskinclick(this)"><span class="color01"><em></em></span></a>
                                        <a href="javascript:void(0)" onclick="onskinclick(this)"><span class="color02"><em></em></span></a>
                                        <a href="javascript:void(0)" onclick="onskinclick(this)"><span class="color03"><em></em></span></a>
                                        <a href="javascript:void(0)" onclick="onskinclick(this)"><span class="color04"><em></em></span></a>
                                        <a href="javascript:void(0)" onclick="onskinclick(this)"><span class="color05"><em></em></span></a>
                                	</div>
                            	</div>
                                <div class="con-wrap">
                            		<h4>显示粉丝数：</h4>
                                	<input name="pluginCfg[wbx_line]" class="input-box size-w" type="text" value="<?php echo XWB_plugin::pCfg('wbx_line');?>" onblur="updatePreview()"  /> 行
                                    <p id="line_warn_tip">行数在1-7之间</p>
                            	</div>
                        </div>
                	</div>
                	<div class="panel-r">
                	    <input type="hidden" name="pluginCfg[wbx_url]" value="<?php echo XWB_plugin::pCfg('wbx_url');?>"/>
                		<iframe width="220" scrolling="no" height="360" id="wbx_preview_iframe" frameborder="0" src="" class="exp-main"></iframe>
                	</div>
            	</div>
...
<script type="text/javascript">
    var skin = $id('siteRegFrom')['pluginCfg[wbx_style]'].value;
    eachNode($id('skin_set'), 'A', function(item, idx){
        if(skin == idx)
          item.className = 'on';
    });
    updatePreview();
