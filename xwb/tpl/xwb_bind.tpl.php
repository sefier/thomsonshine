...
<script type="text/javascript" language="javascript">
    ...
    function ubindTip()
    {
        ...
        setTimeout("window.location='<?php echo XWB_plugin::URL("xwbSiteInterface.bind");?>'", 100);
    }
</script>
</head>
<body>
    <div id="bound" class="set-wrap">
		<h3><!--动态同步新浪微博--><span>把我的动态同步到新浪微博，更更多的朋友了解我，关注我<em>（设置后可选择是否同步）</em></span></h3>
        <div class="main">
        	<div class="con-l">
        	
        		<form id="userProfileBind" action="<?php echo XWB_plugin::URL('xwbSiteInterface.setUserProfileBind');?>" method="post" target="xwbSiteRegister" >
            	<div class="set-sle">
                	<div class="choice">
                    	<label for="part1">
                ...
                <p>已经绑定新浪微博：<strong><a href="<?php echo 'http://t.sina.com.cn/' . $domain;?>" target="_blank"><?php echo $screenName;?></a></strong>
            ...
            <div class="con-r">
            	...
            	<div class="official">
                    ...
                    <div class="users">
                    	<a href="http://t.sina.com.cn/<?php echo $owbUserRs['id'];?>" target="_blank"><img alt="官方微博头像" src="<?php echo $owbUserRs['local_image_url']?$owbUserRs['local_image_url']:XWB_plugin::getPluginUrl('images/bgimg/0.gif');?>" /></a>
                        <div class="user-info">
                            <p><?php echo $owbUserRs['screen_name'];?></p>
                            <a id="ocFriend" class="addfollow-btn <?php echo TRUE === $friendship?'hidden':'';?>"  target="_blank" href="<?php echo XWB_plugin::URL('xwbSiteInterface.attention', "att_id={$owbUserRs['id']}");?>" onclick="setFriend(this)"></a>
                ...
                <div class="active">
                    ...
                    <div class="users">
                        <a href="<?php echo "http://t.sina.com.cn/{$value['sina_uid']}"?>" target="_blank"><?php echo $value['avatar'];?></a>
                        <div class="user-info">
                            <p><?php echo XWB_plugin::convertEncoding($value['username'], XWB_S_CHARSET, 'UTF-8');?></p>
                            <?php if($isBind):?>
                            <a id="huFriend" class="addfollow-btn <?php echo TRUE === $value['friends']?'hidden':'';?>" target="_blank" href="<?php echo XWB_plugin::URL('xwbSiteInterface.attention', "att_id={$value['sina_uid']}");?>" onclick="setFriend(this)"></a>
                            <?php else:?>
                            <a class="addfollow-btn" href="<?php echo "http://t.sina.com.cn/{$value[sina_uid]}"?>"></a>
                            <?php endif;?>
