...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function xwbShowRs(page)
        {
            ...
            XWBcontrol.util.connect('<?php echo XWB_plugin::URL("xwbSiteInterface.ocSearch");?>&' + Math.random(), {
                method : 'POST',
        ...
        function xwbShowHead(id, name)
        {
            ...
            XWBcontrol.util.connect('<?php echo XWB_plugin::URL("xwbSiteInterface.doPluginCfg4oc");?>&' + Math.random(), {
                method : 'POST',
                ...
                success : function(rst) {
                    if (rst.error_no) {
                        ...
                        if(rst.local_image_url){
                            data.push('<a href="http://t.sina.com.cn/' + domain + '" target="_blank">'
                        ...
                        data.push('<div class="info">'
                            ...
                            + '<div class="link"><a target="_blank" href="http://t.sina.com.cn/' + domain + '">http://t.sina.com.cn/' + domain + '</a></div>'
                        );
                        data.push('</div>');
                ...
                <div class="part-s1">
                    ...
                    <div class="sle" id="headArea">
                        ...
                        <div class="user-pic">
                            ...
                            <a href="<?php echo 'http://t.sina.com.cn/' . $domain;?>" target="_blank">
                        ...
                        <div class="info">
                            ...
                            <!--a href="#">修改</a-->
                            <div class="link">
                                <a href="<?php echo 'http://t.sina.com.cn/' . $domain;?>" target="_blank"><?php echo 'http://t.sina.com.cn/' . $domain;?></a>
                            </div>
                        </div>
                        <?php else:?>
