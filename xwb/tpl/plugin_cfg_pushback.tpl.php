...
function xwbSetPushbackAuthKey()
{
    ...
    XWBcontrol.util.connect('<?php echo XWB_plugin::URL("pushbackInterface.doCfg4setAuthKey");?>', {
        method : 'POST',
        data : '',
...
<body>
    <div id="comment_back" class="set-wrap push-div-height">
    	<div class="wrap-inner">
        	<h3 class="main-title">评论回流设置</h3>
            <form action="<?php echo XWB_plugin::URL("pushbackInterface.doCfg4pushback");?>" id="siteRegFrom"  method="post" target="xwbHideFrame">
            	<ul>
                	<li>
