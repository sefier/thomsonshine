<?php
/*
 * @version $Id: cfg.php 591 2011-01-20 01:59:40Z yaoying $
 */
/// 安装配置文件
//-----------------------------------------------------------------------
...
/// 环境的版本检查选项 >=1 <=2
$_xwb_install['site_ver']	= array('1.5','1.5');
...
$_xwb_install['func_chk'][] = 'fsockopen';
...
//$_xwb_install['create_table']['xwb_bind_blog'] = <<<EOT
//
//CREATE TABLE IF NOT EXISTS `%s` (
...
//EOT;
//
//$_xwb_install['create_table']['xwb_bind_doing'] = <<<EOT
//
//CREATE TABLE IF NOT EXISTS `%s` (
//  `id` BIGINT(20) UNSIGNED NOT NULL DEFAULT '0',
//  `mid` BIGINT(20) UNSIGNED NOT NULL,
...
//
//
//$_xwb_install['create_table']['xwb_bind_article'] = <<<EOT
//CREATE TABLE IF NOT EXISTS `%s` (
//  `id` BIGINT(20) UNSIGNED NOT NULL DEFAULT '0',
//  `mid` BIGINT(20) UNSIGNED NOT NULL,
//  PRIMARY KEY  (`id`,`mid`)
...
//EOT;
//
//$_xwb_install['create_table']['xwb_bind_share'] = <<<EOT
//CREATE TABLE IF NOT EXISTS `%s` (
//  `id` BIGINT(20) UNSIGNED NOT NULL DEFAULT '0',
//  `mid` BIGINT(20) UNSIGNED NOT NULL,
//  PRIMARY KEY  (`id`,`mid`)
