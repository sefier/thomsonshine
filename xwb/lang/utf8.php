<?php
/*
 * @version $Id: utf8.php 523 2011-01-04 08:30:40Z yaoying $
 */
$_LANG = array(
	...
	'xwb_want_to_share2weibo' => '<a href="home.php?mod=spacecp&ac=plugin&id=sina_xweibo:home_binding">我要把分享同步到新浪微博</a>',
	'xwb_allow_share2weibo' => '您发布的分享会同步到您的新浪微博。<a href="home.php?mod=spacecp&ac=plugin&id=sina_xweibo:home_binding">不想同步？</a>',

	'xwb_want_to_doing2weibo' => '<a href="home.php?mod=spacecp&ac=plugin&id=sina_xweibo:home_binding">我要把记录同步到新浪微博</a>',
	'xwb_allow_doing2weibo' => '您发布的记录会同步到您的新浪微博。<a href="home.php?mod=spacecp&ac=plugin&id=sina_xweibo:home_binding">不想同步？</a>',
