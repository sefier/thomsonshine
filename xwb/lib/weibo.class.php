...
require_once dirname(__FILE__). "/fsockopenHttp.class.php";
 ...
 * @version $Id: weibo.class.php 591 2011-01-20 01:59:40Z yaoying $
 *
 */
class weibo
 {
	...
	function _delBindCheck( $errmsg ){
		...
		$db = XWB_plugin::getDB();
		$db->query('DELETE FROM ' . XWB_S_TBPRE . 'xwb_bind_info WHERE `uid`=' . XWB_S_UID);
		$sess = XWB_plugin::getUser();
		$sess->clearToken();
