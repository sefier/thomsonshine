 ...
 * @copyright SINA INC.
 * @version $Id: core.class.php 498 2010-12-29 10:26:23Z yaoying $
 */
class XWB_plugin {
	...
	function getPluginUrl($path=''){
		return "http://www.test3g.com/".XWB_P_DIR_NAME."/".$path;
	}
	...
	function pathUrl(){
		...
		$_scriptUrl = (false !== ($offset = strrpos($_scriptUrl, '/'))) ? substr($_scriptUrl, 0, $offset + 1) : $_scriptUrl;
		return $_scriptUrl;
	}
