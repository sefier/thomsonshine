 ...
 * @author yaoying
 * @since 2010-12-22
 * @version $Id: sitePushback2share.class.php 521 2011-01-04 02:50:07Z yaoying $
 *
 */
class sitePushback2share{
	...
	function execInsert(){
		...
		if( !empty($this->_commentData) ){
			$this->_db->query("INSERT INTO ". XWB_S_TBPRE. "home_comment 
		...
		foreach( $this->_shareCountData as $sid => $data ){
			$this->_db->query("UPDATE ". XWB_S_TBPRE. "home_share
