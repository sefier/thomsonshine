 ...
 * @author yaoying
 * @since 2010-12-22
 * @version $Id: pushbackCommunicator.class.php 497 2010-12-29 02:41:11Z yaoying $
 *
 */
class pushbackCommunicator{
	...
	function createAuthHash(){
		$key = (string)XWB_Plugin::pCfg('pushback_authkey');
		return md5($this->appkey. $this->appsecret. $key);
	}
