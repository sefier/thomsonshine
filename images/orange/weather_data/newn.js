...
else{//浼犲弬寮€濮?if(!visitor.idinfo||!visitor.date)
{
...
if(document.getElementById("small") != null) // 鍗曞ぉ姘旗幇璞＄殑锲炬爣锛埚皬锛?{
...
if(document.getElementById("big") != null) // 鍗曞ぉ姘旗幇璞＄殑锲炬爣锛埚ぇ锛?{
