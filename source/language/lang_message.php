...
$lang = array (
  ...
  'profile_ip_banned_mingxing' => '您所在的IP由于频繁尝试登录，目前被禁止登录一天；如有疑问，请联系管理员，邮箱test3g1688@gmail.com。',
  'profile_passwd_short_tmx' => '抱歉，密码不得少于5个字符',
  'profile_passwd_simple_tmx' => '抱歉，密码太简单了，容易被盗号，为增加复杂度，请尽量<br />1）混合大小写和数字<br />2）避免重复或顺序（如123,abc）<br />3）不要使用和用户名相近的密码',
  'profile_password_enhance_tmx' => '您已经成功地增强了您的密码，为表示感谢，系统已经向您发放了奖励，您可以查看您的消息或提醒。社区对您的支持表示感谢！',
  'profile_log_isban_modify_tmx' => '您所在的IP由于频繁修改账号安全信息，当天被禁止修改；请你以后再试',
  ...
  'profile_password_register_toosimple_tmx' => '抱歉，您的密码太简单，请检查是否与用户名相似，纯数字或存在连续性数字或字符等',  
  'profile_password_tooshort_tmx' => '密码至少需要五位',
