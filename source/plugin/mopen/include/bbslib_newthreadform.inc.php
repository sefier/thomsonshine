...
$typeselect = isset($_G['forum']['threadtypes']['types']) && is_array($_G['forum']['threadtypes']['types']) && is_array($typename);
...
$html .= '<a href="index.php?mocmd=newthread" class="posturl">newthreadurl</a>';
...
$tpl->setBool('typeselect', $typeselect!=0);
$tpl->setArray('typename', $typename);
//日志回传相关
