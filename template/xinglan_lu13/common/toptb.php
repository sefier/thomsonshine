...
<div id="wi_toptb" class="cl">
  ...
  <div class="wp cl">
    ...
    <div class="y">
      ...
      <a href="javascript:;" id="wqmenu" onMouseOver="showMenu({'ctrlid':'wqmenu','pos':'34!','ctrlclass':'a','duration':2});">导航<span class="arrow"></span></a>

      <span class="wi_tpipe"></span>

      <a href="javascript:;" id="wmn" {if $_G['member']['newpm'] || $_G['member']['newprompt']}class="new"{/if} onMouseOver="showMenu({'ctrlid':'wmn','pos':'34!','ctrlclass':'a','duration':2});">消息<span class="arrow"></span></a>

      <span class="wi_tpipe"></span>

      <a href="javascript:;" id="wmod" onMouseOver="showMenu({'ctrlid':'wmod','pos':'34!','ctrlclass':'a','duration':2});">管理<span class="arrow"></span></a>
      ...
      <a id="wist" href="javascript:;" onMouseOver="showMenu({'ctrlid':'wist','pos':'34!','ctrlclass':'a','duration':2});" title="{lang changestyle}" style="display:none;">换肤<span class="arrow"></span></a>
...
<div id="wist_menu" class="wi_pop" style="display: none;">
  ...
  <ul class="wi_skin cl">
    ...
    <!--{if !$_G[style][defaultextstyle]}--><li onClick="extstyle('')" title="默认"><i></i></li><!--{eval $i=2}--><!--{else}--><!--{eval $i=1}--><!--{/if}-->
