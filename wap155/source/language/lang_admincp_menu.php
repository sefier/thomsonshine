...
(
	...
	//note 后台一级菜单(top)	变量名必须以 header_ 开头
	...
	//note 后台二级菜单(left)	变量名必须以 menu_ 开头

	//note leftmenu_index
	'menu_home' => '管理中心首页',
	'menu_home_clearhistorymenus' => '清空历史操作',

	//note leftmenu_global
	...
	//手机浏览器设置menu(IN_MOBILE)
	'menu_setting_mobile' => '手机访问设置',

	//note leftmenu_forums
	'menu_forums' => '版块管理',
